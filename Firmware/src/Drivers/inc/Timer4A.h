...
// ***************** Timer4A_SetPeriod ****************
// Change Timer4A reload value on the fly (takes effect next cycle)
// Inputs:  period in units (1/clockfreq), same as Timer4A_Init
// Outputs: none
void Timer4A_SetPeriod(uint32_t period);
